...
const projectsData: Project[] = [
  {
    ...
    description:
      "Full-stack e-commerce platform with payment integration, product management, and user authentication systems.",
    fullDescription:
    ...
    challenges:
      "Implementing secure payment processing while maintaining performance and user experience.",
    solutions:
      "Integrated Stripe with webhooks for secure transactions and used Redis for caching to improve performance.",
    technologies: [
      {
        name: "Frontend",
        items: ["React", "Redux", "Tailwind CSS", "Context API"],
      },
      {
        name: "Backend",
      ...
      {
        name: "Services",
        items: ["Stripe API", "Cloudinary", "JWT", "Nodemailer"],
      },
    ],
  },
  {
    ...
    description:
      "Cross-platform mobile banking application with biometric authentication and transaction features.",
    fullDescription:
      "A secure mobile banking application built with React Native that provides users with a seamless banking experience. Features include fingerprint authentication, transaction history, bill payments, and fund transfers with real-time notifications.",
    ...
    challenges:
      "Ensuring bank-level security while maintaining app performance and user experience.",
    solutions:
      "Implemented biometric authentication, end-to-end encryption, and optimized React Native performance for smooth user experience.",
    technologies: [
      {
        name: "Frontend",
        items: ["React Native", "Redux", "Styled Components"],
      },
      {
        name: "Backend",
      ...
      {
        name: "Security",
        items: ["JWT", "Biometric Auth", "Encryption"],
      },
    ],
  },
];
...
export default function ProjectView() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black overflow-hidden">
      ...
      <section ref={heroRef} className="relative pt-24 pb-16 md:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <Link
              href="/projects"
              className="inline-flex items-center text-electric-blue hover:text-cyan-400 font-medium transition-colors group mb-6"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="project-hero-title text-4xl sm:text-5xl font-bold mb-6 text-black dark:text-white">
                {project.title}
              </h1>
              ...
              <div className="project-hero-meta flex flex-wrap gap-4 mb-8">
                <div className="flex items-center gap-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                  <FaCalendar className="text-electric-blue" />
                  <span className="text-black dark:text-white">
                    {project.year}
                  </span>
                </div>
                <div className="flex items-center gap-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                  <FaTag className="text-electric-blue" />
                  <span className="text-black dark:text-white">
                    {project.category}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                  <FaCode className="text-electric-blue" />
                  <span className="text-black dark:text-white">
                    {project.role}
                  </span>
                </div>
              ...
              <div className="project-hero-actions flex flex-wrap gap-4">
                <a
                  ...
                  className="flex items-center gap-2 bg-gray-800 dark:bg-gray-700 text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-900 dark:hover:bg-gray-600 transition-colors"
                >
                  <FaGithub />
                  View Code
                </a>
      ...
      {/* Content Section */}
      <section ref={contentRef} className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="content-section">
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <h3 className="text-xl font-semibold mb-3 text-electric-blue">
                  Challenges
                </h3>
            ...
            <div className="content-section">
              ...
              <div className="space-y-6">
                {project.technologies.map((tech, index) => (
                  <div
                    key={index}
                    className="bg-gray-50 dark:bg-gray-800 p-5 rounded-xl border border-gray-100 dark:border-gray-700"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="tech-stack-item">
              <h3 className="text-xl font-semibold mb-4 flex items-center gap-2 text-electric-blue">
      ...
      {/* Call to Action */}
      <section className="py-16 bg-gradient-to-br from-electric-blue/5 to-electric-blue/5">
