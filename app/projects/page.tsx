...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Browser-based 2D adventure game with physics engine and multiplayer capabilities.",
    tags: ["Unity", "C#", "Photon"],
  ...
  },
  {
    ...
    description:
      "Web-based task management system with drag-and-drop functionality and team collaboration features.",
  ...
  },
  {
    ...
    description:
      "Augmented reality application that lets users visualize furniture in their space before purchasing.",
...
export default function Projects() {
  ...
  useEffect(() => {
    ...
    tagElements.forEach((tag) => {
      ...
      enterHandlers.set(tag, enter);
      leaveHandlers.set(tag, leave);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 overflow-hidden">
      ...
      <div ref={heroRef} className="text-center mb-16">
        <h1 className="projects-hero-title text-4xl sm:text-5xl font-bold mb-4 text-black dark:text-white">
          My{" "}
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map(
              (page) => (
                <button
                  ...
                  className={`pagination-item px-4 py-2 border rounded-lg transition-colors ${
                    currentPage === page
