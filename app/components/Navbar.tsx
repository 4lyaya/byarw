        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <Link
                ...
                className={`relative px-1 py-2 text-sm font-medium transition-colors ${
                  pathname === link.path
                    ? "text-electric-blue"
                    : "text-gray-700 dark:text-gray-300 hover:text-electric-blue"
                }`}
              >
                {link.name}
                {pathname === link.path && (
                  <span className="absolute bottom-0 left-0 w-full h-0.5 bg-electric-blue rounded-full"></span>
                )}
              </Link>
            ))}
            ...
            <button
              ...
              className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-electric-blue hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            >
              {darkMode ? (
